...
func (l *Lexer) readNumber() string {
	...
	// returning the substring of the input from the position of the first
	// digit to the position of the last digit
	return l.input[position:l.position]
}
...
func (l *Lexer) peekChar() byte {
	// peek at the next character without incrementing readPosition and
	// position
